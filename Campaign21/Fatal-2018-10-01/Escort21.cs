...
//public class Mission : BaseMission, IMainMission
{
    ...
    */
    ...
    public class MissionObjectives
    {
        ...
        public void RadarPositionTriggersSetup()
        {
            ...
            addRadar("Radar Poole",             "PooR", 1, 2, "BTarget28", "TGroundDestroyed",  75, 70423, 171706, 200, 25000,  false, 50, "");
  ...
  RTarget54R TGroundDestroyed 100 17036 77666 50
        ...
        {
            //Format: addTrigger(MO_ObjectiveType.Building (Aircraft, airport, etc), "Name,        FlakID,     OwnerArmy,Points,ID,TriggerType,PercRequired,XLoc,YLoc,Radius,IsPrimaryTarget,IsPrimaryTargetWeight,Comment "");
            ...
            */
            ...
            addTrigger(MO_ObjectiveType.Building, "Low smoke Diesel Le Havre",          "LeHa", 2, 2, "RTarget38", "TGroundDestroyed", 70, 161702, 52073, 100, false, 100, "");  //This is in Le Havre, fuel tanks area. I added 3-4 jerry cans to the area in the .mis so it is a valid target now //g
            addTrigger(MO_ObjectiveType.AA, "Calais Water treatment",                   "Cala", 2, 1, "9A", "TGroundDestroyed", 63, 296130, 218469, 50, false, 2, ""); //I think the locations of the AAA batteries are off? Ok, checking with the .mis file, the order was just reversed and the wrong name with the wrong battery. 1A..9A vs 9A..1A.  Now fixed to match .mis file 9/19/2018
            addTrigger(MO_ObjectiveType.AA, "Calais Army Barracks",                     "Cala", 2, 1, "8A", "TGroundDestroyed", 75, 294090, 85100, 100, false, 2, "");
            addTrigger(MO_ObjectiveType.AA, "Calais Rope Factory",                      "Cala", 2, 1, "7A", "TGroundDestroyed", 66, 293279, 84884, 100, false, 2, "");
         //   addTrigger(MO_ObjectiveType.AA, "Boulogne AAA battery 1",                   "Boul", 2, 1, "6A", "TGroundDestroyed", 70, 317402, 196038, 100, false, 2, "");
         //   addTrigger(MO_ObjectiveType.AA, "Boulogne AAA battery 2",                   "Boul", 2, 1, "5A", "TGroundDestroyed", 47, 266055, 190488, 100, false, 2, "");
         //   addTrigger(MO_ObjectiveType.AA, "Boulogne AAA battery 3",                   "Boul", 2, 1, "4A", "TGroundDestroyed", 51, 264801, 188807, 50, false, 2, "");
        //    addTrigger(MO_ObjectiveType.AA, "Poix Nord AAA battery 2",                  "Poix", 2, 1, "3A", "TGroundDestroyed", 62, 285982, 216833, 50, false, 2, "");
        //    addTrigger(MO_ObjectiveType.AA, "Poix Nord AAA battery 1",                  "Poix", 2, 1, "2A", "TGroundDestroyed", 54, 283234, 215851, 50, false, 2, "");
         //   addTrigger(MO_ObjectiveType.AA, "Poix Nord AAA battery 3",                  "Poix", 2, 1, "1A", "TGroundDestroyed", 77, 283224, 216619, 50, false, 2, "");
            addTrigger(MO_ObjectiveType.AA, "LehavNaval1 main facility",                "LeHa", 2, 1, "LehavNaval1", "TGroundDestroyed", 84, 163216, 49915, 50, false, 100, "");    //added to targets list in mission and here in CS  fatal 9/22
            addTrigger(MO_ObjectiveType.AA, "LehavNaval2 Officer mess",                 "LeHa", 2, 1, "LehavNaval2", "TGroundDestroyed", 71, 163447, 49855, 50, false, 100, "");
            addTrigger(MO_ObjectiveType.AA, "LehavNaval3 weapons training",             "LeHa", 2, 1, "LehavNaval3", "TGroundDestroyed", 75, 163313, 50063, 50, false, 100, "");
            addTrigger(MO_ObjectiveType.AA, "LehavNaval4 Underwater repair training",   "LeHa", 2, 1, "LehavNaval4", "TGroundDestroyed", 81, 163039, 49798, 50, false, 100, "");
            addTrigger(MO_ObjectiveType.AA, "LehavNaval5 Naval Intelligence",           "LeHa", 2, 1, "LehavNaval5", "TGroundDestroyed", 71, 163172, 49816, 50, false, 100, "");
            addTrigger(MO_ObjectiveType.AA, "LehavNaval6 Meteorolgy",                   "LeHa", 2, 1, "LehavNaval6", "TGroundDestroyed", 89, 163470, 49752, 50, false, 100, "");
            addTrigger(MO_ObjectiveType.AA, "LehavNaval7 Naval cryptologic HQ",         "LeHa", 2, 1, "LehavNaval7", "TGroundDestroyed", 75, 162993, 49927, 50, false, 100, "");
    ...
    public void MO_WritePrimaryObjectives()
    {
        ...
        var backPath = STATSCS_FULL_PATH + CAMPAIGN_ID + @" campaign backups\";
        string filepath_date = backPath + CAMPAIGN_ID + @"_MapObjectives-" + dt.ToString("yyyy-MM-dd-HH-mm-ss") + ".ini";
