...
<body>
   ...
   <h3>Tacview Files for Download</h3>  
    ...
    <p>To preserve the "fog of war" and the fun of the TWC Server, the files do not show a massive, radar-like overview of the entire server and everything in it.   </P>
    <p>Rather, the view is similar to what the player pilots see in the sim, showing just a limited sight-bubble around each live pilot. 
    <p>Doing this also MASSIVELY reduces the download file size - a raw file from just one session can easily be a gigabyte or more of data with 5-10 million lines, or even more.  The "fog of war" files are a small fraction of that size, and much more manageable.</p>
    <p>   <a href="https://github.com/syn111/tacview-filter">syn111's tacview-filter script</a> is used to create the "fog of war" files.</p>
