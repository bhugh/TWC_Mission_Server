...
public class Mission : AMission
{
    ...
    */
    ...
    string osk_RedObjDescription = "Red Objectives: Le Havre Harbor Fuel Dump (AQ06.1) - Le Havre Dam (AR05.4) - Ouistreham Dam (AN03.8)";
    string osk_BlueObjDescription = "Blue Objectives: Portsmouth Fuel Dump (AH-20.3) - Cowes Dam (AG19.8) - Hamble Dam (AG21.1)";
    ...
    public override void OnStationaryKilled(int missionNumber, maddox.game.world.GroundStationary stationary, maddox.game.world.AiDamageInitiator initiator, int eventArgInt)
    {
        ...
        ******************************************************************/
        ...
        /************************************************
         * 
         * And, check to see if anyone has turned the map
         * 
         ************************************************/

        //RED has turned the map
        if (!osk_MapTurned && osk_LeHavreDam_destroyed && osk_OuistrehamDam_destroyed && osk_LeHavreFuelStorage_destroyed)
        {
            osk_MapTurned = true;
            EndMission(60, "RED");
        ...
        if (!osk_MapTurned && osk_HambleDam_destroyed && osk_CowesDam_destroyed && osk_PortsmouthFuelStorage_destroyed)
        {
            osk_MapTurned = true;
            EndMission(60, "BLUE");
...
AiAircraft Aircraft, AiDamageInitiator DamageFrom, part.NamedDamageTypes WhatDamaged)
 ...
 {DamageFrom.Player, shortName, WhatDamaged});
   ...
   */
   ...
   /*   
    *   We have a different onTrigger going now, so rem-ing this one out
   public override void OnTrigger(int missionNumber, string shortName, bool active)
    {
        base.OnTrigger(missionNumber, shortName, active);        
