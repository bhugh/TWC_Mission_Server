...
public class Mission : AMission
{
    ...
    */
    ...
    string osk_RedObjDescription = "Red Objectives: Le Havre Harbor Fuel Dump (AQ06.1) - Le Havre Dam (AR05.4) - Ouistreham Dam (AN03.8) - 50 total Team Kills - 10 more Team Kills than Blue";
    string osk_BlueObjDescription = "Blue Objectives: Portsmouth Fuel Dump (AH-20.3) - Cowes Dam (AG19.8) - Hamble Dam (AG21.1) - 50 total Team Kills - 10 more Team Kills than Red";
    ...
    public void CheckMapTurned()
    {
        ...
        if (!osk_MapTurned && osk_LeHavreDam_destroyed && osk_OuistrehamDam_destroyed && osk_LeHavreFuelStorage_destroyed && RedTotalF >= 5000 && RedTotalF > BlueTotalF + 1000)//remember the BlueTotalF & RedTotalF are victories X 100, so five victories is 500 etc.  We use RedTotalF >= 5000 here, rather than osk_Red50Kills == true, because the team may get 50 kills but then LOSE SOME due to penalty points.
        {
        ...
        if (!osk_MapTurned && osk_HambleDam_destroyed && osk_CowesDam_destroyed && osk_PortsmouthFuelStorage_destroyed && BlueTotalF >= 5000 && BlueTotalF > RedTotalF + 1000)//remember the BlueTotalF & RedTotalF are victories X 100, so five victories is 500 etc.
        {
