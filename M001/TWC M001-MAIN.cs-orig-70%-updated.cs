...
public class Mission : AMission
{
    ...
    public int CampaignMapMaxRedSuffixMax = 14; //This implies you have initairports files named with suffix ie -R001, -R002, -R003, -R004 through the max
    public int CampaignMapMaxBlueSuffixMax = 15; //This implies you have initairports files named ie -B001, -B002, -B003, -B004 through the max
    ...
    public Mission() {
        ...
        randRedTickFighterRaid1 = random.Next((int)(endsessiontick * 2 / 90), (int)(endsessiontick * 80 / 90)); //spawn a fighter raid in between minutes 2 & 80 of 90        
        /*
...
public void displayMessages(int tick = 0, int tickoffset = 0, int respawntick = 20000) {
    ...
    public bool LoadRandomSubmission(string fileID = "randsubmission")
    {
        ...
        //So, in 4.5 too many AI aircraft overload the server & create long load times & rubber banding, etc.
        //so we started out loading about 36 AI aircraft missions. This worked in 4.312. In 4.5, via experimentation we determined that reducing this by 33% (to about 24 total missions) helped, but it wasn't really fully corrected until we reduced it by 50% (to 18 total missions).
        //So I went & eliminated 10 of the randRedTickFighterRaid missions but added 2 hurristrafes in their place.  So that eliminates 8 total raids of 36, leaving 28.  Still too many probably.
        //70% of 28 is 19.6 so we'll see if it will run under that load now.  70% still had some long load times so trying 45% to see if it might be a little better.
        if (fileID.StartsWith(MISSION_ID + "-" + "randsubmission") && random.Next(100) > 85) 
        {
