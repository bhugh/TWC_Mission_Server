...
public class Mission : AMission
{
    ...
    //Constants constants; 
    public int PERCENT_SUBMISSIONS_TO_LOAD = 90; //percentage of the aircraft sub-missions to load.  50 will load just half of the sub-missions etc.
    ...
    public Mission() {
        ...
        randBlueTick1 = random.Next((int)(endsessiontick * 3 / 90), (int)(endsessiontick * 18 / 90));  //between minute 5 & 18
