...
public class BattlePos250 : TWCMissionBattles
 
{
    ...
    //public MissionNeg10()
    {
        ...
        red_target_airfield = "Scegga No. 3 Airfield";  //The names of these two airfield must match EXACTLY with the name given 
        blue_target_airfield = "Tariq Airfield"; //to these airports/spawnpoints in the file  focus_airport_misfile_name

        focus_airport_misfile_name = "FocusAirports-Scegga-No3-Tariq.mis"; //this file must be found in subdir battle_subdirectory + focusairport_subdirectory but DON'T ADD THOSE IN HERE or you'll be unhappy;
        ...
        bumrush_redred_misfile_namematch = "Tobruk_Campaign-Rush-Red-Scegga Airfield"; //redred means red won the initial mission & is trying to advance to the airport; red is currently bumrushing that airport
        bumrush_redblue_misfile_namematch = "Tobruk_Campaign-Rush-Blue-Scegga Airfield"; //redblue means red won the initial mission & is trying to advance to that airport; blue is currently counterattacking that airport
        bumrush_bluered_misfile_namematch = "Tobruk_Campaign-Rush-Red-Tariq Airfield";  //Scegga No3 is the airport Blue is trying to take over in this mission; this is the Red counterattack
        bumrush_blueblue_misfile_namematch = "Tobruk_Campaign-Rush-Blue-Tariq Airfield";  //Scegga No3 is the airport Blue is trying to take over in this mission; this is the Blue attack

        Console.WriteLine("Pos250 inited, {0} {1} {2} {3}", score, leastScore, mostScore, focus_airport_misfile_name);
    ...
    public override void MissionObjectiveTriggersSetup(bool addNewOnly = false)
    {
        ...
        mmo.addTrigger(M.MO_ObjectiveType.Convoy, "Habata Resupply Convoy", "Habat", po_dir + "Tobruk_Campaign-LOADONCALL-Blue-HabataResupplyConvoy-objective.mis", "2006_Chief", 2, 5, "BHabataResupplyConvoy", "TGroupDestroyed", 100, 241212, 138043, 100, false, 200, 24, "", add);  //g
        mmo.addTrigger(M.MO_ObjectiveType.Convoy, "El Adem Resupply Convoy", "EAdem1_2", po_dir + "Tobruk_Campaign-LOADONCALL-Red-ElAdemResupplyConvoy-objective.mis", "2007_Chief", 2, 5, "RTobrukElAdemResupplyConvoy", "TGroupDestroyed", 100, 150983, 37668, 100, false, 200, 24, "", add);  //g    

        mmo.addTrigger(M.MO_ObjectiveType.Convoy, "Scegga Resupply Convoy", "Sceg", po_dir + "Tobruk_Campaign-LOADONCALL-Blue-SceggaResupplyConvoy-objective.mis", "2009_Chief", 1, 5, "BSidiSceggaResupplyConvoy", "TGroupDestroyed", 100, 272959, 72853, 100, false, 200, 24, "", add);  //g
        mmo.addTrigger(M.MO_ObjectiveType.Convoy, "Bomba Resupply Convoy", "BombaN", po_dir + "Tobruk_Campaign-LOADONCALL-Red-BombaResupplyConvoy-objective.mis", "2008_Chief", 1, 5, "RBombaResupplyConvoy", "TGroupDestroyed", 100, 79756, 158961, 100, false, 200, 24, "", add);  //g 
        ...
        mmo.addPointArea(M.MO_ObjectiveType.MilitaryArea, "Gazala Fuel", "Gaz2_3", po_dir + "Tobruk_Campaign-LOADONCALL-Red-GazalaFuel-objective.mis", 2, 5, "RTarGazalaFuel", 97004, 199277, 200, 150, 2500, 8, 200, 48, false, true, 3, 7, "", add);
        ...
        mmo.addPointArea(M.MO_ObjectiveType.MilitaryArea, "Inland Fuel Dump", "", po_dir + "Tobruk_Campaign-LOADONCALL-Red-GermanFuelDump-objective.mis", 2, 5, "GermanFuelDump", 127713, 197435, 200, 150, 2500, 8, 200, 48, false, true, 3, 7, "", add);
        mmo.addPointArea(M.MO_ObjectiveType.MilitaryArea, "Armor Camp", "", po_dir + "Tobruk_Campaign-LOADONCALL-Red-GermanArmorCamp-objective.mis", 2, 5, "GerArmorCamp", 197355, 60348, 125, 100, 1800, 30, 200, 48, false, true, 3, 7, "", add);
        ...
        mmo.addPointArea(M.MO_ObjectiveType.MilitaryArea, "Alam El Neiyat Armor Camp", "", po_dir + "Blue-AlamElNeiyatBritishArmorCamp-objective.mis", 1, 5, "BTargAlamNeiyat", 267854, 76291, 150, 125, 2800, 8, 200, 48, false, true, 3, 7, "", add);
...
///********************************************************************** *
/// BHabataResupplyConvoy TGroupDestroyed 2009_Chief 100                  * Chiefs have no specified area of origin   yet
/// RSiwiSceggaResupplyConvoy TGroupDestroyed 2008_Chief 100              *^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
/// RBombaResupplyConvoy TGroupDestroyed 2007_Chief 100                   * the above line will be removed when finished
/// RTobrukElAdemResupplyConvoy TGroupDestroyed 2000_Chief 100            *
/// BTagAlamBarghut TGroundDestroyed 100 287733 118539 350                *
/// BTargAlamNeiyat TGroundDestroyed 100 267854 76291 35                  *
/// BTargAwdyat TGroundDestroyed 100 231676 30075 350                     *
/// BTargBirElMalla TGroundDestroyed 100 359414 98907 250                 *
/// RTarGazalaFuel TGroundDestroyed 100 97004 199277 250                  *
/// GerArmorCamp TGroundDestroyed 74 197355 60348 200                     *
/// GermanFuelDump TGroundDestroyed 75 127713 197435 400                  *
/// MarsaBelaFuelDump TGroundDestroyed 73 205735 176664 350               *
///************************************************************************
