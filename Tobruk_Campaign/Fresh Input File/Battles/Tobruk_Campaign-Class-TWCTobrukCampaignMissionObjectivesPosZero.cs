...
public class BattlePosZero : TWCMissionBattles
 
{
    ...
    public BattlePosZero(maddox.game.IGamePlay g, Mission m, double sc)
    ...
    //public MissionNeg10()
    {
        ...
        leastScore = -50000000; //until we get other battles in place we just leave this very small/large to cover any possibility of score
        mostScore = 50; //Will be 250 when we have Pos300 etc;

        battle_subdirectory = "Battles/BattlePosZero/"; //this will be found inside the main mission directory. Suggest making it match this Class Name within the 'Battles' subdirectory, like "Battles/BattlePos100/" Must end with /

        //Note: You can put each of these into a separate subdirectory if you want but after trying it I found it easier to just keep them all in the battle_subdirectory where you can keep an eye on them more easil  y
        ...
        red_target_airfield = "Scegga No3 Airfield";  //The names of these two airfield must match EXACTLY with the name given 
        blue_target_airfield = "Tariq Al Ghubay Airfield"; //to these airports/spawnpoints in the file  focus_airport_misfile_name

        focus_airport_misfile_name = "FocusAirports-Scegga-No3-Tariq.mis"; //this file must be found in subdir battle_subdirectory + focusairport_subdirectory but DON'T ADD THOSE SUBDIRECTORIES IN HERE or you'll be unhappy;
        ...
        bumrush_redred_misfile_namematch = "Tobruk_Campaign-Rush-Red-Scegga No3 Airfield"; //redred means red won the initial mission & is trying to advance to the airport; red is currently bumrushing that airport
        bumrush_redblue_misfile_namematch = "Tobruk_Campaign-Rush-Blue-Scegga No3 Airfield"; //redblue means red won the initial mission & is trying to advance to that airport; blue is currently counterattacking that airport
        ...
        Console.WriteLine("PosZero inited, {0} {1} {2} {3}", score, leastScore, mostScore, focus_airport_misfile_name);
...
// British moving Objectives			
			
			

        mmo.addTrigger(M.MO_ObjectiveType.Convoy, "El Adem Resupply Convoy", "EAdem1_2", po_dir + "Tobruk_Campaign-LOADONCALL-Red-ZeroElAdemResupplyConvoy-objective.mis", "Zero7_Chief", 2, 5, "RTobrukElAdemResupplyConvoy", "TGroupDestroyed", 100, 150983, 37668, 100, false, 200, 24, "", add);  //g    
        mmo.addTrigger(M.MO_ObjectiveType.Convoy, "Bomba Resupply Convoy", "BombaN", po_dir + "Tobruk_Campaign-LOADONCALL-Red-ZeroBombaResupplyConvoy-objective.mis", "Zero8_Chief", 2, 5, "RBombaResupplyConvoy", "TGroupDestroyed", 100, 79756, 158961, 100, false, 200, 24, "", add);  //g 
       ...
       mmo.addTrigger(M.MO_ObjectiveType.Ship, "Bardia U-Boat", "", "Battles/Objectives/Tobruk_Campaign-LOADONCALL-GerSubmarine-objective.mis", "2001_Chief", 2, 5, "RBardiaUboot", "TGroupDestroyed", 100, 267437, 149991, 100, false, 200, 24, "", add);  //g            		

	   
// German Moving Objectives
            
 
        mmo.addTrigger(M.MO_ObjectiveType.Convoy, "Habata Resupply Convoy", "Habat", po_dir + "Tobruk_Campaign-LOADONCALL-Blue-ZeroHabataResupplyConvoy-objective.mis", "Zero6_Chief", 1, 5, "BHabataResupplyConvoy", "TGroupDestroyed", 100, 241212, 138043, 100, false, 200, 24, "", add);  //g
        ...
        mmo.addTrigger(M.MO_ObjectiveType.Convoy, "Siwi Resupply Convoy", "Siwi", po_dir + "Tobruk_Campaign-LOADONCALL-Blue-ZeroSiwiResupplyConvoy-objective.mis", "Zero1_Chief", 1, 5, "BTargZeroSiwiResupplyConvoy", "TGroupDestroyed", 100, 272959, 72853, 100, false, 200, 24, "", add);  //g
...
// German Objectives
        ...
        mmo.addPointArea(M.MO_ObjectiveType.MilitaryArea, "Sofafi Reserves", "", po_dir + "Tobruk_Campaign-LOADONCALL-Blue-ZeroSofafiReserves-objective.mis", 1, 5, "BTargZeroSofafiReserves", 359414, 98907, 350, 125, 2500, 6, 200, 48, false, true, 3, 7, "", add);
        mmo.addPointArea(M.MO_ObjectiveType.MilitaryArea, "Halfaya Pass Armor Camp", "Helfire", po_dir + "Tobruk_Campaign-LOADONCALL-Blue-ZeroHalfayaPassBritishArmorCamp-objective.mis", 1, 5, "BTagHalfayaPass", 267854, 76291, 350, 125, 2800, 8, 200, 48, false, true, 3, 7, "", add);
        ...
        mmo.Airfield_to_FlakMissions = new Dictionary<string, string>()
            {
                    ...
                    { "ToBC_1", "/Flak areas/TobrukCity&1flak.mis" },
                    { "ToB2_3", "/Flak areas/Torbuk2_3flak.mis" },
                    { "Timi", "/Flak areas/Timi_1flak.mis" },
                    { "None", "/Flak areas/Noneflak.mis" },
