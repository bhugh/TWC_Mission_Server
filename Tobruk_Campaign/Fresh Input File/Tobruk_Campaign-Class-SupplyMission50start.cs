...
public class SupplyMission : AMission, ISupplyMission
{
    ...
    public Dictionary<ArmiesE, Dictionary<string, double>> AircraftSupplyDefault = new Dictionary<ArmiesE, Dictionary<string, double>>
    {
		...
		{"tobruk:Aircraft.BeaufighterMkIC",100},
		{"tobruk:Aircraft.BeaufighterMkIF_Late",100},		
        ...
        {"tobruk:Aircraft.SpitfireMkIIb",50},
        {"tobruk:Aircraft.SpitfireMkVa",50},
        {"tobruk:Aircraft.SpitfireMkVb",50},
        {"tobruk:Aircraft.SpitfireMkVb-HF",50},
        {"tobruk:Aircraft.SpitfireMkVb-HF-Late",50},
		{"tobruk:Aircraft.SpitfireMkVbLate",50},
        {"tobruk:Aircraft.TomahawkMkII",50},
	    {"tobruk:Aircraft.WellingtonMkIc_Late",50},
	    {"tobruk:Aircraft.HurricaneMkIIa",50},
	    {"tobruk:Aircraft.HurricaneMkIIb",50},
	    {"tobruk:Aircraft.HurricaneMkIIc",50},
	    {"tobruk:Aircraft.HurricaneMkIId",50},
        {"tobruk:Aircraft.KittyhawkMkIA",50},
		{"bob:Aircraft.SpitfireMkIIa",50},
        {"tobruk:Aircraft.MartletMkIII",50},
        {"tobruk:Aircraft.WellingtonMkIc_Late",100},
		/*bob:Aircraft.WellingtonMkIc=300.647357579865 */
        } },//Blue aircraft
	    ...
	    {"tobruk:Aircraft.Bf-109E-7",50},		
        {"tobruk:Aircraft.Bf-109E-7N",50},
        {"tobruk:Aircraft.Bf-109E-7Z",50},
        {"tobruk:Aircraft.Bf-109F-2",50},
        {"tobruk:Aircraft.Bf-109F-2_Late",50},
		{"tobruk:Aircraft.He-111H-6",100},
		{"tobruk:Aircraft.Ju-88A-5",100},
		{"tobruk:Aircraft.Ju-88A-5Late",100},
		{"tobruk:Aircraft.Ju-88C-1",100},
		{"tobruk:Aircraft.Ju-88C-2",100},
		{"tobruk:Aircraft.Ju-88C-2",100},
		{"tobruk:Aircraft.Ju-88C-4Late",100},				
		{"tobruk:Aircraft.Macchi-C202-SeriesIII",100},
		{"tobruk:Aircraft.Macchi-C202-SeriesVII",100},
        }
        }
