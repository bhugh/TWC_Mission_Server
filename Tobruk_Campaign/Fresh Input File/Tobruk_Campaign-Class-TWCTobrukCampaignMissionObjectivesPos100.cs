 ...
 
{
    ...
    public override void MissionObjectiveTriggersSetup(bool addNewOnly = false)
    {
        ...
        //      -technique for this is to give the chief a distinctive name in the .mis file.  See examples below "1006_Chief" ""1009_Chief" etc.  You can use about anything reason "2020_MyFavoriteObjective" etc
        ...
        mmo.addTrigger(M.MO_ObjectiveType.Convoy, "Sidi-Scegga Resupply Convoy", "", po_dir + "Tobruk_Campaign-LOADONCALL-Blue-BSidiSceggaResupplyConvoy-objective.mis", "1010_Chief", 1, 5, "BSidiSceggaResupplyConvoy", "TGroupDestroyed", 100, 327607, 126528, 100, false, 200, 24, "", add);  //g
