...
<head>
    ...
    <script src="res/md5.min.js"></script> 
...
xmlhttp.onreadystatechange = function(){
  ...
  function loadingmessage () {
       ...
       if (typeof(mymap) !== 'undefined') msg("Loading, please wait . . . ");
       if (document.getElementById("playerlist") != null) document.getElementById("playerlist").innerHTML = "<br><br><table border=1 width=80% align=center>\"Loading, please wait . . . \"</table><br><br>";

  }                  

  function checkpassword (showmess=true) {
     //var hash = md5("value"); // "2063c1608d6e0baf80249c42e2be5804"
     if (serverpass != md5(pass.toUpperCase())){
       if (showmess){
  ...
  function drawAircraft () {   
    ...
    function maplines (item) {
        ...
        if (words.length == 1 && words[0].charAt(0)=="p" ){
          serverpass = words[0].trim().substring(1,words[0].length); 
        }
...
function readfile () {
         ...
         side = urlParams['side'];
         if ((!side || side== "Other") && urlParams['sideoth'] != null && urlParams['sideoth'].length>0) side = urlParams['sideoth'];
         pass = urlParams['pass'] 
...
} else echo "<i>Loading . . . <br> <br><a href=\"index.php\">Click here to return to the radar entry page and restart</a></i>";
?>
