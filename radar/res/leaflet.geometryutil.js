...
L.GeometryUtil = L.extend(L.GeometryUtil || {}, {
    ...
    */
    ...
    //project a point outwards in directi of heading by distance
        project: function(latlng, heading, distance) {
        heading = (heading + 360) % 360;
        var rad = Math.PI / 180,
            radInv = 180 / Math.PI,
            lon1 = latlng.lng,
            lat1 = latlng.lat,
            rheading = heading * rad,            
            cosDist = Math.cos(rheading) * distance,
            sinDist = Math.sin(rheading) * distance,
            lat2 = lat1 + cosDist,
            lon2 = lon1 + sinDist;
